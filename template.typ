...
#let ink    = rgb("#18181b")        // near-black for titles and headings
#let muted  = rgb("#686868")        // neutral gray for secondary text
#let rule-c = rgb("#d1d1d1")        // light gray for rules

// environment colors
#let c-thm  = rgb("#a11212")       // deep red for theorems
#let c-def  = rgb("#2a2a2a")       // charcoal for definitions
#let c-prop = rgb("#b32626")       // muted red for propositions and cover accents
#let c-con  = rgb("#565656")       // dark gray for examples
#let c-rem  = rgb("#7a7a7a")       // medium gray for remarks
  ...
  block(
    ...
    align(left, {
      ...
      context {
        ...
        // Keep the environment heading as one inline object. Otherwise, when
        // the first fragment of the body moves to the next line, paragraph
        // justification stretches the spaces inside the heading itself.
        let header = text(weight: "semibold", fill: color,
          label
...
#let Fld = $bold(sans("Fld"))$
#let CAlg = $bold(sans("CAlg"))$
#let coAlg = $bold(sans("coAlg"))$
#let Mon = $bold(sans("Mon"))$
#let CMon = $bold(sans("CMon"))$
#let Assoc = $bold(sans("Assoc"))^times.o$
#let LM = $bold(sans("LM"))^times.o$
#let RM = $bold(sans("RM"))^times.o$
#let BM = $bold(sans("BM"))^times.o$
#let Tens = $bold(sans("Tens"))^times.o$
